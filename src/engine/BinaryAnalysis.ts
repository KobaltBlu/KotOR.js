 ...
 * 
 * This module documents the reverse-engineered findings from analyzing K1 and TSL
 * executable binaries (swkotor.exe and swkotor2.exe) via AgentDecompile/Ghidra.
 * 
...
/**
 * Binary memory layout information extracted from PE headers via Ghidra
 */
...
// K1 Binary Layout (from agentdecompile analysis)
...
// TSL Binary Layout (from agentdecompile analysis)
...
export const CRITICAL_IMPORTS = {
  ...
  USER32: [
    ...
    "GetWindowRect", "ClientToScreen", "ScreenToClient"
  ],
...
/**
 * String table locations identified via agentdecompile
 */
...
export const BINARY_REFERENCES: BinaryReference[] = [
  {
    ...
    sourceAnalysis: "AgentDecompile bookmark"
  },
  {
  ...
  },
  {
    ...
    sourceAnalysis: "AgentDecompile string listing"
  },
  {
    label: "CODE_SECTION_START",
    address: 0x00401000,
