...
export class SWIPSpellSchool {
  ...
  static From2DA(row: any = {}){
    const propsDef = new SWIPSpellSchool();
    ...
    if(row.hasOwnProperty('letter'))
      propsDef.letter = TwoDAObject.normalizeValue(row.letter, 'string', '') as string;
