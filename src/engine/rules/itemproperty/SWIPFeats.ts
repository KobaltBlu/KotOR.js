...
export class SWIPFeats {
  ...
  static From2DA(row: any = {}){
    ...
    if(row.hasOwnProperty('featindex'))
      propsDef.featindex = TwoDAObject.normalizeValue(row.featindex, 'number', -1) as number;
