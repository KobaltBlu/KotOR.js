...
function getTexelEncodingFunction( functionName: any, encoding: any ) {
...
function getToneMappingFunction( functionName: any, toneMapping: any ) {
...
function generateExtensions( parameters: any ) {
...
function filterEmptyLine( string: any ) {
...
function resolveIncludes( string: any ) {

	return string.replace( includePattern, includeReplacer );

}

function includeReplacer( match: any, include: any ) {
...
function generateShadowMapTypeDefine( parameters: any ) {
	...
	} else if ( parameters.shadowMapType === THREE.VSMShadowMap ) {
...
function WebGLProgram( renderer: any, cacheKey: any, parameters: any, bindingStates: any ) {
	...
	if ( parameters.isRawShaderMaterial ) {
		...
		prefixFragment = [
			...
			THREE.ShaderChunk[ 'encodings_pars_fragment' ], // this code is required here because it is used by the various encoding/decoding function defined below
	...
	if ( parameters.isWebGL2 && parameters.isRawShaderMaterial !== true ) {
		...
		prefixFragment = [
			'#define varying in',
			( parameters.glslVersion === THREE.GLSL3 ) ? '' : 'layout(location = 0) out highp vec4 pc_fragColor;',
			( parameters.glslVersion === THREE.GLSL3 ) ? '' : '#define gl_FragColor pc_fragColor',
