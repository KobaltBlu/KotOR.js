...
export const LayoutContainer = function (props: LayoutContainerProps) {
  ...
  const calculateLayout = (width: number = 0, height: number = 0) => {
    ...
    const north_gutter_size = layout_north_enabled
      ? layoutNorthOpen.current
        ? layoutBarOpenSize.current
        : layoutBarClosedSize.current
      : 0;

    const south_gutter_size = layout_south_enabled
      ? layoutSouthOpen.current
        ? layoutBarOpenSize.current
        : layoutBarClosedSize.current
      : 0;

    const east_gutter_size = layout_east_enabled
      ? layoutEastOpen.current
        ? layoutBarOpenSize.current
        : layoutBarClosedSize.current
      : 0;

    const west_gutter_size = layout_west_enabled
      ? layoutWestOpen.current
        ? layoutBarOpenSize.current
        : layoutBarClosedSize.current
      : 0;
    ...
    if (!south_gutter_size) {
      ...
      southHandleStyle = {
        position: 'absolute',
        top: layoutSouthOpen.current
          ? tabHeight - south_bounds.height - south_gutter_size
          : tabHeight - south_gutter_size,
  ...
  return (
    <div ref={containerRef} className="layout-container">
      ...
      <Draggable
        bounds="parent"
        axis="y"
        onStart={(e) => handleStart(e, 'north')}
        onStop={(e) => handleStop(e, 'north')}
        defaultPosition={{ x: 0, y: northHandleStyle.top }}
      >
        <div
          ref={northHandleRef}
        ...
        >
          <div
            ref={northHandleToggleRef}
            onClick={(e) => onPaneToggle(e, 'north')}
            className="ui-layout-toggler ui-layout-toggler-north ui-layout-toggler-open ui-layout-toggler-north-open"
            title="Close"
          ></div>
        </div>
      </Draggable>
      <Draggable
        bounds="parent"
        axis="y"
        onStart={(e) => handleStart(e, 'south')}
        onStop={(e) => handleStop(e, 'south')}
        defaultPosition={{ x: 0, y: southHandleStyle.top }}
      >
        <div
          ref={southHandleRef}
        ...
        >
          <div
            ref={southHandleToggleRef}
            onClick={(e) => onPaneToggle(e, 'south')}
            className="ui-layout-toggler ui-layout-toggler-south ui-layout-toggler-open ui-layout-toggler-south-open"
            title="Close"
          ></div>
        </div>
      </Draggable>
      <Draggable
        bounds="parent"
        axis="x"
        onStart={(e) => handleStart(e, 'east')}
        onStop={(e) => handleStop(e, 'east')}
        defaultPosition={{ x: eastHandleStyle.left, y: 0 }}
      >
        <div
          ref={eastHandleRef}
        ...
        >
          <div
            ref={eastHandleToggleRef}
            onClick={(e) => onPaneToggle(e, 'east')}
            className="ui-layout-toggler ui-layout-toggler-east ui-layout-toggler-open ui-layout-toggler-east-open"
            title="Close"
          ></div>
        </div>
      </Draggable>
      <Draggable
        bounds="parent"
        axis="x"
        onStart={(e) => handleStart(e, 'west')}
        onStop={(e) => handleStop(e, 'west')}
        defaultPosition={{ x: westHandleStyle.left, y: 0 }}
      >
        <div
          ref={westHandleRef}
        ...
        >
          <div
            ref={westHandleToggleRef}
            onClick={(e) => onPaneToggle(e, 'west')}
            className="ui-layout-toggler ui-layout-toggler-west ui-layout-toggler-open ui-layout-toggler-west-open"
            title="Close"
          ></div>
        </div>
      </Draggable>
