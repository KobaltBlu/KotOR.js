 ...
 */
export async function fetchUpdateInfo(updateLink: string, timeoutMs: number = 15000): Promise<RemoteUpdateInfo> {
...
export async function getRemoteUpdateInfo(
  ...
  const updateLink = useBetaChannel ? LOCAL_PROGRAM_INFO.updateBetaInfoLink : LOCAL_PROGRAM_INFO.updateInfoLink;
