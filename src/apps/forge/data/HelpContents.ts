...
export const HELP_TOOLS: HelpFolder = {
  name: 'Tools',
  documents: [doc('Module Editor', 'tools/1-moduleEditor.md'), doc('Map Builder', 'tools/2-mapBuilder.md')],
};
...
export const HELP_FOLDERS: HelpFolder[] = [HELP_INTRODUCTION, HELP_TOOLS, HELP_TUTORIALS];
