  ...
  const tabs: SubTab[] = [
            ...
            <tbody>
              ...
              >
                <input
                  ...
                  value={genericType}
                  onChange={onUpdateNumberField(setGenericType, 'genericType')}
                />
              </FormField>
              <tr>
                <td>
                  <InfoBubble
                    content="If checked, this door/trigger is part of the main story and cannot be destroyed or bypassed by normal means."
                    position="right"
                  >
                    <ForgeCheckbox
                      label="Plot Item"
                ...
                <td>
                  <InfoBubble
                    content="If checked, this door/trigger cannot be moved, rotated, or modified by scripts or other game mechanics."
                    position="right"
                  >
                    <ForgeCheckbox
                      label="Static"
          ...
          <table style={{ width: '100%' }}>
            <tbody>
              <tr>
                <td>
                  <InfoBubble
                    content="If checked, this door/trigger starts in a locked state and requires a key or lockpicking to open."
                    position="right"
                  >
                    <ForgeCheckbox
                      label="Locked"
              ...
              <tr>
                <td>
                  <InfoBubble
                    content="If checked, this door/trigger can be locked again after being unlocked. If unchecked, it remains unlocked once opened."
                    position="right"
                  >
                    <ForgeCheckbox
              ...
              <tr>
                <td>
                  <InfoBubble
                    content="If checked, the key will be automatically removed from the player's inventory after successfully unlocking the door/trigger."
                    position="right"
                  >
                    <ForgeCheckbox
              ...
              <tr>
                <td>
                  <InfoBubble
                    content="If checked, a key is required to both lock and unlock this door/trigger. If unchecked, it can be locked/unlocked without a key."
                    position="right"
                  >
                    <ForgeCheckbox
            ...
            <tbody>
              ...
              >
                <input
                  ...
                  min="0"
                  value={openLockDC}
                  onChange={onUpdateNumberField(setOpenLockDC, 'openLockDC')}
                />
              </FormField>
              <FormField
                label="Close Lock DC"
              ...
              >
                <input
                  ...
                  min="0"
                  value={closeLockDC}
                  onChange={onUpdateNumberField(setCloseLockDC, 'closeLockDC')}
                />
              </FormField>
              <FormField
                label="Key Name"
          ...
          <table style={{ width: '100%;' }}>
            <tbody>
              ...
              <tr>
                <td>
                  <InfoBubble
                    content="The conversation that plays when this door/trigger is interacted with. Leave empty for no conversation."
                    position="right"
                  >
                ...
                <td>
                  <input
                    type="text"
                    placeholder="Enter conversation resref"
                    maxLength={16}
                    style={{ width: 'auto' }}
                    value={conversationResRef}
                    onChange={onUpdateResRefField(setConversationResRef, 'conversation')}
                  />
                  <div className="ui-checkbox" style={{ display: 'inline-block' }}>
                    <InfoBubble
                      content="If checked, this conversation can be interrupted by combat or other events. If unchecked, the conversation must complete before other actions."
                      position="right"
                    >
                      <ForgeCheckbox
                        label="Interruptable"
              ...
              >
                <input
                  ...
                  onChange={onUpdateNumberField(setAnimationState, 'animationState')}
                />
              </FormField>
            </tbody>
          </table>
    ...
    },
    {
      ...
      content: (
        <>
          <InfoBubble
            content="The description text that appears when players examine this door/trigger. This can be localized for different languages and is what players see in the examine window."
            position="right"
          >
    ...
    },
    {
      ...
      content: (
        <>
          <InfoBubble
            content="Developer notes and comments about this door/trigger. These are not visible to players and are only for your reference during development."
            position="right"
          >
