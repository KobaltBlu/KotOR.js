...
import type {
  ...
  KnownSpellEntry,
  SpecialAbilityEntry,
} from '@/apps/forge/module-editor/ForgeCreature';
...
export const TabUTCEditor = function (props: BaseTabProps) {
  ...
  useEffect(() => {
    if (!tab) return;
    setFeats(
      KotOR.SWRuleSet.feats.filter((feat) => feat.label != '' && feat.prereqFeat2 == -1 && feat.prereqFeat1 == -1)
    );
    setSpells(KotOR.SWRuleSet.spells.filter((spell) => spell.userType == 1 && spell.prerequisites.length == 0));
    setSpecialAbilitiesList(
      KotOR.SWRuleSet.spells.filter((spell) => spell.userType == 2 && spell.prerequisites.length == 0)
    );
  ...
  const onSpellClick = (index: number) => (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const hasPrereq =
      spell.prerequisites.length == 0 ||
      spell.prerequisites.map((id) => spellList.find((s) => s.spell == id)).every((has) => has);
  ...
  const onSpecialAbilityClick = (index: number) => (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const hasPrereq =
      specialAbility.prerequisites.length == 0 ||
      specialAbility.prerequisites.map((id) => specialAbilities.find((s) => s.spell == id)).every((has) => has);
                ...
                <tr>
                  ...
                  <td>
                    <select
                      ...
                      onChange={onUpdateNumberField(setAppearanceType, 'appearanceType')}
                    >
                  ...
                  <td>
                    ...
                    >
                      {KotOR.SWRuleSet.phenotypes.map((phenotype) => (
                        <option key={phenotype.id} value={phenotype.id}>
                          {phenotype.getName()}
                        </option>
                      ))}
                    </select>
                  ...
                  <td>
                    ...
                    >
                      {KotOR.SWRuleSet.bodyBags.map((bodyBag) => (
                        <option key={bodyBag.id} value={bodyBag.id}>
                          {bodyBag.label}
                        </option>
                      ))}
                    </select>
            ...
            <div className="d-flex">
              ...
              <div className="flex-grow-1">
                <select
                  className="form-select"
                  value={portraitId}
                  onChange={onUpdateNumberField(setPortraitId, 'portraitId')}
                >
            ...
            <table style={{ width: '100%' }}>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input type="number" min="0" value={str} onChange={onUpdateNumberField(setStr, 'str')} />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" min="0" value={dex} onChange={onUpdateNumberField(setDex, 'dex')} />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" min="0" value={con} onChange={onUpdateNumberField(setCon, 'con')} />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" min="0" value={int} onChange={onUpdateNumberField(setInt, 'int')} />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" min="0" value={wis} onChange={onUpdateNumberField(setWis, 'wis')} />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <input type="number" min="0" value={cha} onChange={onUpdateNumberField(setCha, 'cha')} />
                  </td>
                </tr>
              </tbody>
            </table>
                ...
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      min="0"
                      value={fortbonus}
                      onChange={onUpdateNumberField(setFortbonus, 'fortbonus')}
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      min="0"
                      value={refbonus}
                      onChange={onUpdateNumberField(setRefbonus, 'refbonus')}
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <input
                      ...
                      min="0"
                      value={willbonus}
                      onChange={onUpdateNumberField(setWillbonus, 'willbonus')}
                    />
                  </td>
                </tr>
              </tbody>
                ...
                <td style={{ width: '50%' }}>
                  <fieldset>
                    ...
                    <input
                      ...
                      min="0"
                      value={naturalAC}
                      onChange={onUpdateNumberField(setNaturalAC, 'naturalAC')}
                    />
                  </fieldset>
                  <fieldset>
                    <legend>Speed</legend>
                ...
                <td style={{ width: '50%' }}>
                  <fieldset>
                    ...
                    <input
                      ...
                      min="0"
                      value={hitPoints}
                      onChange={onUpdateNumberField(setHitPoints, 'hitPoints')}
                    />
                    ...
                    <input
                      ...
                      onChange={onUpdateNumberField(setCurrentHitPoints, 'currentHitPoints')}
                    />
                    ...
                    <input
                      ...
                      min="0"
                      value={maxHitPoints}
                      onChange={onUpdateNumberField(setMaxHitPoints, 'maxHitPoints')}
                    />
                  </fieldset>
                </td>
              </tr>
          ...
          <fieldset>
            ...
            <table style={{ width: '100%' }}>
              <tbody>
                <tr>
                  <td>
                    <label>Disarmable</label>
                  </td>
                  <td>
                    <ForgeCheckbox
                      label="Disarmable"
                      value={disarmable}
                      onChange={onUpdateForgeCheckboxField(setDisarmable, 'disarmable')}
                    />
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>
                    <label>No Permanent Death</label>
                  </td>
                  <td>
                    <ForgeCheckbox
                      label="No Permanent Death"
                      value={noPermDeath}
                      onChange={onUpdateForgeCheckboxField(setNoPermDeath, 'noPermDeath')}
                    />
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ForgeCheckbox label="Is PC" value={isPC} onChange={onUpdateForgeCheckboxField(setIsPC, 'isPC')} />
                  </td>
                </tr>
                <tr>
                  <td>
                    <label>Minimum 1 HP</label>
                  </td>
                  <td>
                    <ForgeCheckbox
                      label="Minimum 1 HP"
                ...
                <td>
                  <fieldset>
                    ...
                    <input
                      ...
                      onChange={onUpdateNumberField(setChallengeRating, 'challengeRating')}
                    />
                  </fieldset>
                </td>
                <td>
                  <fieldset>
                    ...
                    >
                      {KotOR.SWRuleSet.soundSets.map((soundSet) => (
                        <option key={soundSet.id} value={soundSet.id}>
                          {soundSet.getName()}
                        </option>
                      ))}
                    </select>
              ...
              <tr>
                ...
                <td>
                  <fieldset>
                    ...
                    >
                      {KotOR.SWRuleSet.ranges
                        .filter((range) => range.getType() == 2)
                        .map((size) => (
        ...
        <>
          <div className="feats">
            {feats.map((feat, index) => (
              <div className="feat-row" key={`feat-${feat.id}`}>
                <div
                  className={`feat-icon ${featList.includes(feat.id) ? 'enabled' : 'disabled'}`}
                  onClick={onFeatClick(feat.id)}
                >
                  <InfoBubble content={feat.label} position="right">
                ...
                {feat.nextFeat ? (
                  <>
                    ...
                    <div
                      className={`feat-icon ${featList.includes(feat.nextFeat.id) ? 'enabled' : 'disabled'}`}
                      onClick={onFeatClick(feat.nextFeat.id)}
                    >
                      <InfoBubble content={feat.nextFeat.label} position="right">
                ...
                {feat.nextFeat?.nextFeat ? (
                  <>
                    ...
                    <div
                      className={`feat-icon ${featList.includes(feat.nextFeat.nextFeat.id) ? 'enabled' : 'disabled'}`}
                      onClick={onFeatClick(feat.nextFeat.nextFeat.id)}
                    >
                      <InfoBubble content={feat.nextFeat.nextFeat.label} position="right">
        ...
        <>
          <div className="feats">
            {spells.map((spell, index) => (
              <div className="feat-row" key={`feat-${spell.id}`}>
                <div
                  className={`feat-icon ${knownList0.find((s) => s.spell == spell.id) ? 'enabled' : 'disabled'}`}
                  onClick={onSpellClick(spell.id)}
                >
                  <InfoBubble content={spell.label} position="right">
                ...
                {spell.nextSpell ? (
                  <>
                    ...
                    <div
                      className={`feat-icon ${knownList0.find((s) => s.spell == spell.nextSpell.id) ? 'enabled' : 'disabled'}`}
                      onClick={onSpellClick(spell.nextSpell.id)}
                    >
                      <InfoBubble content={spell.nextSpell.label} position="right">
                ...
                {spell.nextSpell?.nextSpell ? (
                  <>
                    ...
                    <div
                      className={`feat-icon ${knownList0.find((s) => s.spell == spell.nextSpell.nextSpell.id) ? 'enabled' : 'disabled'}`}
                      onClick={onSpellClick(spell.nextSpell.nextSpell.id)}
                    >
                      <InfoBubble content={spell.nextSpell.nextSpell.label} position="right">
            ...
            <>
              <div>
                ...
                <input
                  ...
                  max="100"
                  value={goodEvil}
                  onChange={onUpdateNumberField(setGoodEvil, 'goodEvil')}
                />
                <span>{goodEvil}</span>
              </div>
              <div>
                    ...
                    <tr>
                      ...
                      <td>
                        <select
                          className="form-select"
                          value={creatureClass}
                          onChange={onUpdateClassListField(setCreatureClass, 'class')}
                        >
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          min="0"
                          value={creatureLevel}
                          onChange={onUpdateClassListField(setCreatureLevel, 'level')}
                        />
                      </td>
                    </tr>
                  </tbody>
        ...
        <>
          <div className="feats">
            {specialAbilitiesList.map((specialAbility, index) => (
              <div className="feat-row" key={`feat-${specialAbility.id}`}>
                <div
                  className={`feat-icon ${specialAbilities.find((s) => s.spell == specialAbility.id) ? 'enabled' : 'disabled'}`}
                  onClick={onSpecialAbilityClick(specialAbility.id)}
                >
                  <InfoBubble content={specialAbility.label} position="right">
                ...
                {specialAbility.nextSpell ? (
                  <>
                    ...
                    <div
                      className={`feat-icon ${specialAbilities.find((s) => s.spell == specialAbility.nextSpell.id) ? 'enabled' : 'disabled'}`}
                      onClick={onSpecialAbilityClick(specialAbility.nextSpell.id)}
                    >
                      <InfoBubble content={specialAbility.nextSpell.label} position="right">
                ...
                {specialAbility.nextSpell?.nextSpell ? (
                  <>
                    ...
                    <div
                      className={`feat-icon ${specialAbilities.find((s) => s.spell == specialAbility.nextSpell.nextSpell.id) ? 'enabled' : 'disabled'}`}
                      onClick={onSpecialAbilityClick(specialAbility.nextSpell.nextSpell.id)}
                    >
                      <InfoBubble content={specialAbility.nextSpell.nextSpell.label} position="right">
              ...
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxLength={16}
                    value={scriptAttacked}
                    onChange={onUpdateResRefField(setScriptAttacked, 'scriptAttacked')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxLength={16}
                    value={scriptDamaged}
                    onChange={onUpdateResRefField(setScriptDamaged, 'scriptDamaged')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxLength={16}
                    value={scriptDeath}
                    onChange={onUpdateResRefField(setScriptDeath, 'scriptDeath')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxLength={16}
                    value={scriptDialogu}
                    onChange={onUpdateResRefField(setScriptDialogu, 'scriptDialogu')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptDisturbed}
                    onChange={onUpdateResRefField(setScriptDisturbed, 'scriptDisturbed')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptEndDialogue}
                    onChange={onUpdateResRefField(setScriptEndDialogue, 'scriptEndDialogue')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptEndRound}
                    onChange={onUpdateResRefField(setScriptEndRound, 'scriptEndRound')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptHeartbeat}
                    onChange={onUpdateResRefField(setScriptHeartbeat, 'scriptHeartbeat')}
                  />
                </td>
              </tr>
              <tr>
                <td>
                  <label>On Blocked</label>
                </td>
                <td>
                  <input
                    type="text"
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptOnBlocked}
                    onChange={onUpdateResRefField(setScriptOnBlocked, 'scriptOnBlocked')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptOnNotice}
                    onChange={onUpdateResRefField(setScriptOnNotice, 'scriptOnNotice')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxLength={16}
                    value={scriptRested}
                    onChange={onUpdateResRefField(setScriptRested, 'scriptRested')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    maxLength={16}
                    value={scriptSpawn}
                    onChange={onUpdateResRefField(setScriptSpawn, 'scriptSpawn')}
                  />
                </td>
              </tr>
              <tr>
                <td>
                  <label>Spell At</label>
                </td>
                <td>
                  <input
                    type="text"
                    ...
                    maxLength={16}
                    value={scriptSpellAt}
                    onChange={onUpdateResRefField(setScriptSpellAt, 'scriptSpellAt')}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    ...
                    list={scriptSuggestionListId}
                    maxLength={16}
                    value={scriptUserDefined}
                    onChange={onUpdateResRefField(setScriptUserDefined, 'scriptUserDefined')}
                  />
                </td>
              </tr>
            </tbody>
        ...
        <>
          <div className="iSlots">
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idimplant' : 'iimplant'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.IMPLANT)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idhead' : 'ihead'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.HEAD)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idhands' : 'ihands'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.ARMS)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idforearm_l' : 'iforearm_l'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.LEFTARMBAND)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idarmor' : 'iarmor'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.ARMOR)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idforearm_r' : 'iforearm_r'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.RIGHTARMBAND)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idweap_l' : 'ihand_l'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.LEFTHAND)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idbelt' : 'ibelt'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.BELT)}
            />
            <TextureCanvas
              width={64}
              height={64}
              texture={`${race == 5 ? 'idweap_r' : 'ihand_r'}`}
              onClick={() => handleItemSlotClick(KotOR.ModuleCreatureArmorSlot.RIGHTHAND)}
            />
          </div>
          ...
          <fieldset>
            <legend>
              ...
              <button
                ...
                onClick={() => {
                  const modal = new ModalInventoryBrowserState(tab.creature.itemList, (updatedInventory) => {
