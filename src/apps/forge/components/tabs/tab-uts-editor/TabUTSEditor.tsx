...
const SoundSelector = function (props: { onSelect: (resRef: string) => void; onClose: () => void }) {
  ...
  useEffect(() => {
    const nodes = [
      ...ForgeState.resourceExplorerTab.getStreamSounds(),
      ...ForgeState.resourceExplorerTab.getBifSounds(),
  ...
  const filteredSounds = sounds.filter((sound) => sound.name.toLowerCase().includes(searchQuery));

  return (
    <Modal show={true} onHide={props.onClose} backdrop="static" keyboard={false} size="lg">
            ...
            <div className="file-browser-grid">
              {filteredSounds.map((sound, index) => (
                ...
                >
                  ...
                  <div className="file-name">{sound.name}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <Modal.Footer>
        <Button onClick={isPlaying ? stopPreview : previewSound} disabled={!soundResRef.trim()} className="me-2">
          {isPlaying ? (
            <>
  ...
  const onBtnPlaySound = (e: React.MouseEvent<HTMLButtonElement>, index: number) => {
    ...
    KotOR.AudioLoader.LoadSound(resRef).then((data: any) => {
      KotOR.AudioEngine.GetAudioEngine()
        .audioCtx.decodeAudioData(data.buffer as ArrayBuffer)
        ...
        <div className="vertical-tabs" style={{ height: '100%' }}>
          <div className="vertical-tabs-nav navbar navbar-sidebar-wizard-horizontal" role="navigation">
            <ul className="tabs-menu" style={{ textAlign: 'center' }}>
              <li className={`btn btn-tab ${selectedTab == 'basic' ? 'active' : ''}`}>
                <a onClick={() => setSelectedTab('basic')}>Basic</a>
              </li>
              <li className={`btn btn-tab ${selectedTab == 'position' ? 'active' : ''}`}>
                <a onClick={() => setSelectedTab('position')}>Position</a>
              </li>
            </ul>
          </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div className="btn-group mb-2">
                          <button className="btn btn-primary" onClick={() => tab.startEmitter()}>
                            Start
                          </button>
                          <button className="btn btn-primary" onClick={() => tab.stopEmitter()}>
                            Stop
                          </button>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <textarea
                          value={comments}
                          onChange={onUpdateCExoStringField(setComments, 'comment')}
                        ></textarea>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input type="checkbox" checked={active} onChange={onUpdateBooleanField(setActive, 'active')} />
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <label>{KotOR.SWRuleSet.priorityGroups[priority]?.label}</label>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <div className="btn-group mb-2">
                          <button className="btn btn-primary" onClick={(e) => setShowSoundSelector(true)}>
                            ...
                            <div className="sound-item" key={`sound-item-${index}-${sound}`}>
                              ...
                              <div className="sound-item-buttons">
                                <button
                                  ...
                                  onClick={(e) => onBtnPlaySound(e, index)}
                                  title="Play Sound"
                                >
                                ...
                                <button
                                  className="btn btn-primary"
                                  onClick={(e) => onBtnStopSound(e, index)}
                                  title="Stop Sound"
                                >
                                ...
                                <button
                                  className="btn btn-primary"
                                  onClick={(e) => onBtnMoveUpSound(e, index)}
                                  title="Move Up"
                                >
                                ...
                                <button
                                  className="btn btn-primary"
                                  onClick={(e) => onBtnMoveDownSound(e, index)}
                                  title="Move Down"
                                >
                                ...
                                <button
                                  className="btn btn-primary"
                                  onClick={(e) => onBtnRemoveSound(e, index)}
                                  title="Remove Sound"
                                >
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex">
                          <label className="form-label pr-2" style={{ width: '100px' }}>
                            {volume}
                          </label>
                          <input
                            type="range"
                            ...
                            onChange={(e) => {
                              ...
                              tab.sound.volume = Number(e.target.value);
                              tab.updateFile();
                            }}
                        ...
                        <div className="d-flex">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              tab.sound.volumeVariation = Number(e.target.value);
                              tab.updateFile();
                            }}
                            title={volumeVariation.toString()}
                          />
                        </div>
                      </td>
                    </tr>
                        ...
                        <div className="d-flex">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              tab.sound.pitchVariation = Number(e.target.value);
                              tab.updateFile();
                            }}
                            title={pitchVariation.toFixed(2)}
                          />
                        </div>
                      </td>
                    </tr>
                      ...
                      <td>
                        <div className="d-flex">
                          ...
                          <input
                            ...
                            step="0.01"
                            value={interval}
                            onChange={onUpdateNumberField(setInterval, 'interval')}
                    ...
                    <tr>
                      <td>
                        <label>Interval Variation</label>
                      </td>
                      <td>
                        <div className="d-flex">
                          <label className="form-label pr-2" style={{ width: '100px' }}>
                          ...
                          <input
                            ...
                            onChange={onUpdateNumberField(setIntervalVariation, 'intervalVariation')}
                            title={intervalVariation.toString()}
                          />
                        </div>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <div className="btn-group mb-2">
                          <button
                            className={`btn ${!looping ? 'btn-primary active' : 'btn-default'}`}
                            onClick={() => {
                              onUpdateLooping(false);
                            }}
                          >
                            Single Shot
                          </button>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="btn-group mb-2">
                          <button
                            className={`btn ${!random ? 'btn-primary active' : 'btn-default'}`}
                            onClick={() => {
                              tab.sound.random = false;
                              setRandom(tab.sound.random);
                              tab.updateFile();
                            }}
                          >
                    ...
                    <tr>
                      ...
                      <td style={{ textAlign: 'center' }}>
                        ...
                        <div className="btn-group align-center mb-2">
                          <button
                            className={`btn ${positional == false ? 'btn-primary active' : 'btn-default'}`}
                            onClick={() => toggleSoundType('global')}
                          >
                            Area-Wide
                          </button>
                          <button
                            className={`btn ${positional == true ? 'btn-primary active' : 'btn-default'}`}
                            onClick={() => toggleSoundType('positional')}
                          >
                            Positional
                          </button>
                          <button
                            className={`btn ${randomPosition == true ? 'btn-primary active' : 'btn-default'}`}
                            onClick={() => toggleSoundType('randomPosition')}
                          >
                            Random Position
                          </button>
                        </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          step="0.01"
                          value={minDistance}
                          onChange={onUpdateNumberField(setMinDistance, 'minDistance')}
                          disabled={!positional}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          step="0.01"
                          value={maxDistance}
                          onChange={onUpdateNumberField(setMaxDistance, 'maxDistance')}
                          disabled={!positional}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          step="0.01"
                          value={elevation}
                          onChange={onUpdateNumberField(setElevation, 'elevation')}
                          disabled={!positional}
                        />
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          step="0.01"
                          value={randomRangeX}
                          onChange={onUpdateNumberField(setRandomRangeX, 'randomRangeX')}
                    ...
                    <tr>
                      ...
                      <td>
                        <input
                          ...
                          step="0.01"
                          value={randomRangeY}
                          onChange={onUpdateNumberField(setRandomRangeY, 'randomRangeY')}
                          disabled={!randomPosition}
                        />
                      </td>
                    </tr>
