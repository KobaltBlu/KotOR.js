                  ...
                  <tbody>
                    ...
                    >
                      <input
                        ...
                        maxLength={32}
                        value={linkedTo}
                        onChange={onUpdateCExoStringField(setLinkedTo, 'linkedTo')}
                      />
                    </FormField>
                    <tr>
                      <td></td>
                        ...
                        <table style={{ width: '100%' }}>
                          <tbody>
                            <tr>
                              <td>
                                <InfoBubble
                                  content="If checked, the map note will be displayed on the map when the waypoint is selected."
                                  position="right"
                                >
                                  <ForgeCheckbox
                                    label="Map Note Enabled"
                                    value={mapNoteEnabled}
                                    onChange={onUpdateForgeCheckboxField(setMapNoteEnabled, 'mapNoteEnabled')}
                                  />
                                </InfoBubble>
                              </td>
                              <td>
                                <InfoBubble
                                  content="If checked, the map note will be displayed on the map when the waypoint is moused overed in-game."
                                  position="right"
                                >
                                  <ForgeCheckbox
                                    label="Has Map Note"
                                    value={hasMapNote}
                                    onChange={onUpdateForgeCheckboxField(setHasMapNote, 'hasMapNote')}
                                  />
                                </InfoBubble>
                              </td>
                            </tr>
                    ...
                    >
                      <CExoLocStringEditor
                        value={mapNote}
                        onChange={onUpdateCExoLocStringField(setMapNote, 'mapNote')}
                      />
                    </FormField>
                    <FormField
                      label="Palette ID"
