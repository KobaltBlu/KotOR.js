...
export const SubTabContent = function (props: SubTabContentProps) {
  return <div className="tab-pane-content relative">{props.children}</div>;
};

export const SubTabHost: React.FC<SubTabHostProps> = ({ tabs, defaultTab, leftPanel, contentStyle = {} }) => {
    ...
    <div style={{ height: '100%' }}>
      <div className="vertical-tabs" style={{ height: '100%' }}>
        ...
        <div className="vertical-tabs-container">
          ...
          >
            {tabs.map((tab) => (
              <div key={tab.id} className="tab-pane" style={{ display: selectedTab === tab.id ? 'block' : 'none' }}>
