...
export const GrantAccessInfo = () => {
  return (
    <div className="grant-access-info">
      ...
      <p>
        In supported browsers, this uses the File System Access API to request permission to the folder you select. This
        is important because the app must read game resources and write updated files directly in your install
        directory.{' '}
        <a
