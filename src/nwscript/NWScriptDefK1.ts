...
NWScriptDefK1.Actions = {
  ...
  3: {
    ...
    action: function (this: NWScriptInstance, args: [number, number, number]) {
      const output =
        ('0000000000000000000' + parseInt(args[0].toString())).substr(-args[1]) +
        (args[2] ? ((args[0] % 1) + '00000000000').substr(1, args[2]) : '');
      return output;
    },
  },
  4: {
  ...
  8: {
    ...
    action: function (this: NWScriptInstance, args: [string, ModuleObject, number]) {
      if (args[0]) {
        ...
        console.warn(
          `NWScript.ExecuteScript (${this.name}) failed because a script name wasn't supplied -> ${args[0]}`
        );
      }
    },
  },
  9: {
    ...
    action: function (this: NWScriptInstance, args: []) {
      if (BitWise.InstanceOfObject(this.caller, ModuleObjectType.ModuleCreature)) this.caller.clearAllActions(true);
    },
  },
  10: {
    comment:
  ...
  13: {
    ...
    action: function (this: NWScriptInstance, args: [number]) {
      ...
      return GameState.PartyManager.party.unshift(
        GameState.PartyManager.party.splice(GameState.PartyManager.party.indexOf(pm), 1)[0]
      )
        ? NW_TRUE
        : NW_FALSE;
    },
  ...
  38: {
    ...
    action: function (
      this: NWScriptInstance,
      args: [number, number, ModuleObject, number, number, number, number, number]
    ) {
  ...
  41: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (
        BitWise.InstanceOfObject(this.caller, ModuleObjectType.ModuleObject) &&
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)
      ) {
  ...
  46: {
    ...
    action: function (this: NWScriptInstance, args: [string]) {
      try {
        const oSound = GameState.ModuleObjectManager.GetObjectByTag(
          args[0],
          0,
          NWModuleObjectType.SOUND
        ) as ModuleSound;
        if (!oSound) {
          return;
        }
  ...
  64: {
    ...
    action: function (this: NWScriptInstance, args: [string, string, number]) {
      return [args[0].slice(0, args[2]), args[1], args[0].slice(args[2])].join('');
    },
  },
  65: {
  ...
  86: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleCreature)) {
        const nextId = (this.creatureEffectIndex.get(args[0].id) ?? -1) + 1;
  ...
  116: {
    ...
    args: [NWScriptDataType.OBJECT, NWScriptDataType.INTEGER],
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleCreature)) return args[0].getAC();

      if (
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleItem) ||
  ...
  125: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleCreature]) {
      if (typeof args[0] === 'undefined') return -1;
  ...
  128: {
    ...
    action: function (this: NWScriptInstance, args: [number, number, EngineLocation, number, number, THREE.Vector3]) {
      ...
      const ls = GameState.ModuleObjectManager.GetObjectsInShape(
        args[0],
        args[1],
        args[2],
        !!args[3],
  ...
  129: {
    ...
    action: function (this: NWScriptInstance, args: [number, number, EngineLocation, number, number, THREE.Vector3]) {
      const nextId = (this.objectInSphapeIndex.get(args[0]) ?? -1) + 1;
  ...
  151: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, ModuleObject]) {
      if (
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject) &&
        BitWise.InstanceOfObject(args[1], ModuleObjectType.ModuleObject)
      ) {
  ...
  204: {
    ...
    action: function (
      this: NWScriptInstance,
      args: [ModuleObject, string, number, number, number, string, string, string, string, string, string]
    ) {
      if (BitWise.InstanceOfObject(this.caller, ModuleObjectType.ModuleObject)) {
  ...
  215: {
    ...
    action: function (this: NWScriptInstance, args: [THREE.Vector3, number]) {
      let location = new EngineLocation(args[0].x, args[0].y, args[0].z);
  ...
  217: {
    ...
    args: [NWScriptDataType.OBJECT],
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      return GameState.PartyManager.party.indexOf(args[0] as any) >= 0 || GameState.PartyManager.Player == args[0]
        ? NW_TRUE
        : NW_FALSE;
    },
  },
  ...
  222: {
    ...
    action: function (this: NWScriptInstance, args: []) {
      if (
        BitWise.InstanceOfObject(this.talent, TalentObjectType.TalentObject) &&
        BitWise.InstanceOfObject(this.talent.oTarget, ModuleObjectType.ModuleObject)
      ) {
  ...
  236: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, ModuleObject]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleCreature)) {
        if (
          (GameState.PartyManager.party.indexOf(args[0] as any) >= 0 ? NW_TRUE : NW_FALSE) &&
          (GameState.PartyManager.party.indexOf(args[1] as any) >= 0 ? NW_TRUE : NW_FALSE)
        ) {
          return NW_TRUE;
        }
  ...
  241: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number, number, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)) args[0].destroy();
    },
  },
  242: {
          ...
          if (buffer) {
            ...
            plc.loadModel().then((model: OdysseyModel3D) => {
              plc.loadWalkmesh(model.name).then((pwk: OdysseyWalkMesh) => {
                ...
                try {
                  if (pwk.mesh instanceof THREE.Object3D) model.add(pwk.mesh);
  ...
  255: {
    ...
    action: function (this: NWScriptInstance, args: [string, ModuleObject]) {
      ...
      if (args[0] != '') {
        ...
        GameState.CutsceneManager.startConversation(
          this.listenPatternSpeaker.conversation,
          this.caller,
          this.listenPatternSpeaker as any
        );
        return NW_TRUE;
      } else {
  ...
  263: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleTrigger)) {
        const nextId = (this.persistentObjectIndex.get(args[0].id) ?? -1) + 1;
  ...
  313: {
    ...
    args: [NWScriptDataType.LOCATION],
    action: function (this: NWScriptInstance, args: [EngineLocation]) {
      if (BitWise.InstanceOfObject(this.caller, ModuleObjectType.ModuleCreature)) this.caller.JumpToLocation(args[0]);
    },
  },
  314: {
    comment:
  ...
  319: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, ModuleObject]) {
      if (BitWise.InstanceOfObject(args[1], ModuleObjectType.ModuleObject)) {
        return new THREE.Vector2(args[0].position.x, args[0].position.y).distanceTo(
          new THREE.Vector2(args[1].position.x, args[1].position.y)
        );
      } else {
        return 0.0;
      }
  ...
  335: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)) {
        return new THREE.Vector2(this.caller.position.x, this.caller.position.y).distanceTo(
    ...
    action: function (this: NWScriptInstance, args: [ModuleDoor, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleDoor)) {
        switch (args[1]) {
          ...
          //UNLOCK
          case 1:
            args[0].attemptUnlock(this.caller);
            break;
          //BASH
          case 2:
            this.caller.attackCreature(args[0] as ModuleObject);
            break;
          //IGNORE (UNUSED?)
  ...
  340: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)) {
        if (GameState.PartyManager.party.indexOf(args[0] as ModuleCreature) >= 0) {
          const nextId = (this.objectInventoryIndex.get(-1) ?? -1) + 1;
          this.objectInventoryIndex.set(-1, nextId);
          return GameState.InventoryManager.inventory[nextId];
        } else {
          const nextId = (this.objectInventoryIndex.get(args[0].id) ?? -1) + 1;
  ...
  341: {
    ...
    action: function (this: NWScriptInstance, args: [number, ModuleCreature]) {
      ...
      switch (args[0]) {
        case 1:
          return creature.classes[0]?.id || CreatureClassType.INVALID;
        case 2:
          return creature.classes[1]?.id || CreatureClassType.INVALID;
        case 3:
          return creature.classes[2]?.id || CreatureClassType.INVALID;
      }
  ...
  342: {
    ...
    action: function (this: NWScriptInstance, args: [number, ModuleCreature]) {
      ...
      switch (args[0]) {
        case 1:
          return creature.classes[0]?.level || 0;
        case 2:
          return creature.classes[1]?.level || 0;
        case 3:
          return creature.classes[2]?.level || 0;
      }
      return 0;
    },
  },
  ...
  359: {
    ...
    action: function (this: NWScriptInstance, args: [TalentObject]) {
      return typeof args[0] != 'undefined' && typeof args[0] == 'object' && typeof args[0].objectType != 'undefined'
        ? NW_TRUE
        : NW_FALSE;
    },
  },
  ...
  366: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      ...
      const row = feedback2DA?.rows
        ? (feedback2DA.rows[nTextConstant] ?? feedback2DA.getRowByIndex?.(nTextConstant))
        : undefined;
  ...
  381: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleCreature)) {
        let faction = GameState.FactionManager.GetCreatureFaction(args[0]);
        if (faction) {
          const nextId = (this.factionMemberIndex.get(faction.id) ?? -1) + 1;
  ...
  399: {
    ...
    args: [NWScriptDataType.OBJECT, NWScriptDataType.INTEGER],
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (args[0] == undefined) args[0] = this.caller;

      if (GameState.PartyManager.party.indexOf(args[0] as any) >= 0) return;
      ...
      const equipped = args[1]
        ? (args[0] as ModuleCreature).equipment.LEFTHAND
        : (args[0] as ModuleCreature).equipment.RIGHTHAND;
      ...
      action.setParameter(
        ...
        args[1] ? ModuleCreatureArmorSlot.LEFTHAND : ModuleCreatureArmorSlot.RIGHTHAND
      );
  ...
  413: {
    ...
    args: [NWScriptDataType.OBJECT],
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleSound)) (args[0] as ModuleSound).start();
    },
  },
  414: {
  ...
  424: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, EngineLocation, ModuleObject]) {
      ...
      if (
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleItem) &&
        BitWise.InstanceOfObject((args[0] as any).possessor, ModuleObjectType.ModuleObject)
      ) {
  ...
  455: {
    ...
    args: [NWScriptDataType.OBJECT],
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)) return args[0].plot;
  ...
  456: {
    ...
    args: [NWScriptDataType.OBJECT, NWScriptDataType.INTEGER],
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)) args[0].plot = !!args[1];
    },
  },
  457: {
    comment:
  ...
  503: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number, number, number]) {
      if (
        ...
        const animRows = GameState.TwoDAManager.datatables.get('animations')?.rows;
        const animName = animRows?.[args[1]]?.name;
        this.caller.attackCreature(args[0], undefined, true, args[3], animName ?? '', args[2]);
      } else {
      ...
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleObject)) {
        ...
        if (action) {
          switch (action.type) {
            ...
            case ActionType.ActionItemCastSpell:
              return 19;
            case ActionType.ActionCounterSpell:
              return 31;
            case ActionType.ActionHeal:
              return 33;
            //case ActionType.ActionPickPocket: return 34;
            case ActionType.ActionForceFollowObject:
              return 35;
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModulePlaceable)) {
        ...
        switch (args[1]) {
          ...
          case 0:
            return !(args[0] as ModulePlaceable).locked;
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModulePlaceable)) {
        switch (args[1]) {
          //PLACEABLE_ACTION_OPEN
          case 0:
            (args[0] as ModulePlaceable).use(this.caller);
            break;
          //PLACEABLE_ACTION_UNLOCK_OBJECT
          case 1:
            (args[0] as ModulePlaceable).attemptUnlock(this.caller);
            break;
          //PLACEABLE_ACTION_BASH
          case 2:
            (this.caller as ModuleCreature).attackCreature(args[0] as ModulePlaceable);
            break;
          //PLACEABLE_ACTION_KNOCK
          case 3:
  ...
  551: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      if (
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleTrigger) ||
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleDoor) ||
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModulePlaceable)
      ) {
  ...
  556: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      ...
      return (
        args[0].combatData.lastAttackTarget ||
        args[0].combatData.lastAttacker ||
        args[0].combatData.lastDamager ||
        undefined
      );
    },
  },
  ...
  576: {
    ...
    args: [NWScriptDataType.OBJECT],
    action: function (this: NWScriptInstance, args: [ModuleCreature]) {
      return GameState.PartyManager.party.indexOf(args[0]) >= 0 || args[0] == GameState.PartyManager.Player
        ? NW_TRUE
        : NW_FALSE;
    },
  },
  ...
  586: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, string, number, number, number]) {
      if (
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleMGPlayer) ||
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleMGEnemy)
      ) {
  ...
  588: {
    ...
    action: function (this: NWScriptInstance, args: []) {
      const mg = GameState.module?.area?.miniGame;
      return mg?.lastBulletHitTarget && BitWise.InstanceOfObject(mg.lastBulletHitTarget, ModuleObjectType.ModuleMGEnemy)
        ? 1
        : 0;
    },
  },
  ...
  590: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number, number]) {
      if (
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleMGEnemy) ||
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleMGObstacle) ||
        BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleMGPlayer)
      ) {
  ...
  604: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      ...
      if (
        obj &&
        (BitWise.InstanceOfObject(obj, ModuleObjectType.ModuleMGEnemy) ||
          BitWise.InstanceOfObject(obj, ModuleObjectType.ModuleMGObstacle) ||
          BitWise.InstanceOfObject(obj, ModuleObjectType.ModuleMGPlayer))
      ) {
  ...
  619: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      ...
      if (
        o &&
        (BitWise.InstanceOfObject(o, ModuleObjectType.ModuleMGPlayer) ||
          BitWise.InstanceOfObject(o, ModuleObjectType.ModuleMGEnemy))
      ) {
  ...
  621: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      const o = args[0];
      if (o && BitWise.InstanceOfObject(o, ModuleObjectType.ModuleMGPlayer))
        return (o as ModuleMGPlayer).num_loops ?? 0;
      return 0;
    },
  },
  622: {
  ...
  640: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      ...
      if (
        ...
        const banks = (o as ModuleMGPlayer | ModuleMGEnemy).gunBanks;
        if (banks && banks[idx]?.proto_bullet?.target_type != null)
          return banks[idx].proto_bullet.target_type ? NW_TRUE : NW_FALSE;
      }
      return NW_FALSE;
    },
  },
  ...
  643: {
    ...
    args: [],
    action: function (this: NWScriptInstance, args: []) {
      return GameState.module?.area?.miniGame?.player?.speed ?? 0;
    },
  },
  644: {
    ...
    args: [],
    action: function (this: NWScriptInstance, args: []) {
      return GameState.module?.area?.miniGame?.player?.speed_min ?? 0;
    },
  },
  645: {
    ...
    args: [],
    action: function (this: NWScriptInstance, args: []) {
      return GameState.module?.area?.miniGame?.player?.accel_secs ?? 0;
    },
  },
  646: {
    ...
    args: [],
    action: function (this: NWScriptInstance, args: []) {
      const pos = GameState.module?.area?.miniGame?.player?.tunnel?.pos;
  ...
  654: {
    ...
    action: function (this: NWScriptInstance, args: [THREE.Vector3]) {
      const player = GameState.module?.area?.miniGame?.player;
      if (player?.tunnel) player.tunnel.neg = args[0];
    },
  },
  655: {
  ...
  705: {
    ...
    args: [NWScriptDataType.OBJECT],
    action: function (this: NWScriptInstance, args: [ModuleCreature]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleCreature)) return args[0].aiStyle;
  ...
  707: {
    ...
    args: [NWScriptDataType.OBJECT, NWScriptDataType.INTEGER],
    action: function (this: NWScriptInstance, args: [ModuleObject, number]) {
      if (BitWise.InstanceOfObject(args[0], ModuleObjectType.ModuleCreature)) (args[0] as any).aiStyle = args[1];
    },
  },
  708: {
  ...
  714: {
    ...
    action: function (this: NWScriptInstance, args: [string, number]) {
      ...
      if (!plotTable?.rows) return;
      const count = plotTable.RowCount;
      const rows = plotTable.rows;
      for (let i = 0; i < count; i++) {
        const row = rows[i];
        if (!row) continue;
        if (row.label?.localeCompare(args[0], undefined, { sensitivity: 'base' }) === 0) {
          const xpVal =
            typeof row === 'object' && 'xp' in row ? Number((row as { xp?: unknown }).xp) : parseInt(String(row), 10);
          if (!isNaN(xpVal)) GameState.PartyManager.GiveXP(xpVal * (args[1] * 0.01));
        }
      }
    },
  },
  ...
  728: {
    ...
    action: function (this: NWScriptInstance, args: [ModuleObject]) {
      ...
      const nextId = (this.creatureAttackerIndex.get(args[0].id) ?? -1) + 1;
  ...
  749: {
    ...
    action: function (this: NWScriptInstance, args: []) {
      if (BitWise.InstanceOfObject(this.caller, ModuleObjectType.ModuleObject)) {
        (this as unknown as { conversation: DLGObject | undefined }).conversation = undefined;
      }
