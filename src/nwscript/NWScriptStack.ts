...
export class NWScriptStack {
  ...
  storeState(_bpO: number = 0, spO: number = 0){

    const stack: NWScriptStackVariable[] = [];
    for(let i = 0; i < spO; i++){
  ...
  static FromActionStruct = function( struct: GFFStruct, _object_self?: any ){
