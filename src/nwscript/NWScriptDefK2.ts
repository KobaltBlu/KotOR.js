...
const K2_STUB_RETURN: Record<number, () => unknown> = {
  ...
  [NWScriptDataType.INTEGER]: function () {
    return 0;
  },
  [NWScriptDataType.FLOAT]: function () {
    return 0;
  },
  [NWScriptDataType.STRING]: function () {
    return '';
  },
  [NWScriptDataType.OBJECT]: function () {
    return undefined;
  },
  [NWScriptDataType.EFFECT]: function () {
    return undefined;
  },
  [NWScriptDataType.EVENT]: function () {
    return undefined;
  },
  [NWScriptDataType.LOCATION]: function () {
    return undefined;
  },
  [NWScriptDataType.TALENT]: function () {
    return undefined;
  },
  [NWScriptDataType.VECTOR]: function () {
    return { x: 0, y: 0, z: 0 };
  },
  [NWScriptDataType.STRUCTURE]: function () {
    return undefined;
  },
};
