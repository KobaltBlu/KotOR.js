...
export class EffectSetState extends GameEffect {
  ...
  updateForcePush(delta: number = 0) {
    const v1 = new THREE.Vector3(this.getFloat(0), this.getFloat(1), this.getFloat(2));
    const v2 = new THREE.Vector3(this.getFloat(3), this.getFloat(4), this.getFloat(5));
    ...
    if (this.elapsed < anim_push_length) {
      ...
      this.object.position.set(this.getFloat(3), this.getFloat(4), this.getFloat(5));
      this.object.box.setFromObject(this.object.model);
