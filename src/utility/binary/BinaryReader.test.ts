...
describe('BinaryReader', () => {
  it('reads unsigned and signed integer primitives', () => {
    const data = new Uint8Array([
      0x01, 0x02, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xfe, 0xff, 0xfd,
  ...
  it('reads big-endian primitives when constructed with big endian mode', () => {
    const reader = new BinaryReader(
      new Uint8Array([
        0xff, 0x01, 0xff, 0xff, 0xff, 0x02, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x03, 0xff, 0x01, 0xff, 0xff,
        0xff, 0x02, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x03, 0x3f, 0x80, 0x00, 0x00, 0x3f, 0xf0, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00,
      ]),
      Endians.BIG
    );
