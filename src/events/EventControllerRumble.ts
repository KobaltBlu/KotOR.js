...
/**
 * EventControllerRumble class.
 * 
 * KotOR JS - A remake of the Odyssey Game Engine that powered KotOR I & II
 * 
 * @file EventControllerRumble.ts
 * @author KobaltBlu <https://github.com/KobaltBlu>
 * @license {@link https://www.gnu.org/licenses/gpl-3.0.txt|GPLv3}
 */
export class EventControllerRumble extends GameEvent {

  constructor(){
    super();

    //Event Type
    this.type = GameEventType.EventControllerRumble;
