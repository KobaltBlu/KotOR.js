...
export class ModuleItem extends ModuleObject {
  ...
  initProperties(){
    ...
    if(this.template.RootNode.hasField('AddCost'))
      this.addCost = this.template.getNumberByLabel('AddCost');
    ...
    if(this.template.RootNode.hasField('Charges'))
      this.charges = this.template.getNumberByLabel('Charges');

    if(this.template.RootNode.hasField('Cost'))
      this.cost = this.template.getNumberByLabel('Cost');

    if(this.template.RootNode.hasField('DELETING'))
      this.deleting = this.template.getBooleanByLabel('DELETING');
    ...
    if(this.template.RootNode.hasField('Dropable'))
      this.dropable = this.template.getBooleanByLabel('Dropable');
    ...
    if(this.template.RootNode.hasField('Identified'))
      this.identified = this.template.getBooleanByLabel('Identified');

    if(this.template.RootNode.hasField('Infinite'))
      this.infinite = this.template.getBooleanByLabel('Infinite');
    ...
    if(this.template.RootNode.hasField('NewItem'))
      this.newItem = this.template.RootNode.getBooleanByLabel('NewItem');
    ...
    if(this.template.RootNode.hasField('StackSize'))
      this.stackSize = this.template.getNumberByLabel('StackSize');

    if(this.template.RootNode.hasField('Stolen'))
      this.stolen = this.template.getBooleanByLabel('Stolen');
  ...
  save(){
    ...
    itemStruct.addField( new GFFField(GFFDataType.CEXOLOCSTRING, 'DescIdentified') ).setValue(this.descIdentified ?? new CExoLocString());
