...
export class OdysseyModelNodeMesh extends OdysseyModelNode {
  ...
  readBinary(odysseyModel: OdysseyModel) {
    ...
    if (this.vertexLocArrayDef.count > 1) throw 'Face offsets offsets count wrong ' + this.vertexLocArrayDef.count;
    ...
    if (this.verticesCount == 0 || this.faceArrayDefinition.count == 0) return;
    ...
    for (let i = 0; i < this.verticesCount; i++) {
      ...
      if (this.MDXDataBitmap & OdysseyModelMDXFlag.TANGENT1) {
        ...
        this.tangent1.tangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent1.bitangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent1.normals.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
      ...
      if (this.MDXDataBitmap & OdysseyModelMDXFlag.TANGENT2) {
        ...
        this.tangent2.tangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent2.bitangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent2.normals.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
      ...
      if (this.MDXDataBitmap & OdysseyModelMDXFlag.TANGENT3) {
        ...
        this.tangent3.tangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent3.bitangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent3.normals.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
      ...
      if (this.MDXDataBitmap & OdysseyModelMDXFlag.TANGENT4) {
        ...
        this.tangent4.tangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent4.bitangents.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
        this.tangent4.normals.push(
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle(),
          this.odysseyModel.mdxReader.readSingle()
        );
    ...
    if (this.MDXDataBitmap & OdysseyModelMDXFlag.UV1 && !(this.MDXDataBitmap & OdysseyModelMDXFlag.UV2)) {
      this.tvectors[1] = this.tvectors[0];
    }

    if (this.vertexLocArrayDef.count) {
      this.odysseyModel.mdlReader.position =
        this.odysseyModel.fileHeader.modelDataOffset + this.vertexLocArrayDef.offset;
    ...
    if (this.faceArrayDefinition.count) {
      this.odysseyModel.mdlReader.position =
        this.odysseyModel.fileHeader.modelDataOffset + this.faceArrayDefinition.offset;
      for (let i = 0; i < this.faceArrayDefinition.count; i++) {
        ...
        if (this.MDXDataBitmap & OdysseyModelMDXFlag.UV1)
          this.texCords[0][i] = [
            this.tvectors[0][this.faces[i].a],
            this.tvectors[0][this.faces[i].b],
            this.tvectors[0][this.faces[i].c],
          ];

        if (this.MDXDataBitmap & OdysseyModelMDXFlag.UV2)
          this.texCords[1][i] = [
            this.tvectors[1][this.faces[i].a],
            this.tvectors[1][this.faces[i].b],
            this.tvectors[1][this.faces[i].c],
          ];
      }
    ...
    if (this.InvertedCountArrayDef?.count > 0) {
      this.odysseyModel.mdlReader.seek(
        this.odysseyModel.fileHeader.modelDataOffset + this.InvertedCountArrayDef.offset
      );
