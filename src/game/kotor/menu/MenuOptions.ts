  ...
  async menuControlInitializer(skipInit: boolean = false) {
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      this.BTN_LOADGAME.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[42300].Value);
      });

      this.BTN_SAVEGAME.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[42301].Value);
      });

      this.BTN_GAMEPLAY.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[48006].Value);
      });

      this.BTN_FEEDBACK.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[42274].Value);
      });

      this.BTN_AUTOPAUSE.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[48572].Value);
      });

      this.BTN_GRAPHICS.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[48010].Value);
      });

      this.BTN_SOUND.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[48012].Value);
      });

      this.BTN_QUIT.addEventListener( 'hover', () => {
        this.LB_DESC.setSingleItemDescription(GameState.TLKManager.TLKStrings[42302].Value);
      });
