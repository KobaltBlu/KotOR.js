...
export class CharGenAbilities extends GameMenu {
  ...
  updateButtonStates() {
    ...
    if (this.getAttributeCost(CharGenAttribute.STR) > GameState.CharGenManager.availPoints) this.STR_PLUS_BTN.hide();

    if (this.getAttributeCost(CharGenAttribute.DEX) > GameState.CharGenManager.availPoints) this.DEX_PLUS_BTN.hide();

    if (this.getAttributeCost(CharGenAttribute.CON) > GameState.CharGenManager.availPoints) this.CON_PLUS_BTN.hide();

    if (this.getAttributeCost(CharGenAttribute.WIS) > GameState.CharGenManager.availPoints) this.WIS_PLUS_BTN.hide();

    if (this.getAttributeCost(CharGenAttribute.INT) > GameState.CharGenManager.availPoints) this.INT_PLUS_BTN.hide();

    if (this.getAttributeCost(CharGenAttribute.CHA) > GameState.CharGenManager.availPoints) this.CHA_PLUS_BTN.hide();
