...
const MELEE_ITEMS = [
  BaseItemType.QUARTER_STAFF,
  BaseItemType.STUN_BATON,
  BaseItemType.LONG_SWORD,
  BaseItemType.VIBRO_SWORD,
  BaseItemType.SHORT_SWORD,
  BaseItemType.VIBRO_BLADE,
  BaseItemType.DOUBLE_BLADED_SWORD,
  BaseItemType.VIBRO_DOUBLE_BLADE,
  BaseItemType.WOKIE_WARBLADE,
];
const RANGED_ITEMS = [
  BaseItemType.BLASTER_PISTOL,
  BaseItemType.HEAVY_BLASTER,
  BaseItemType.HOLD_OUT_BLASTER,
  BaseItemType.ION_BLASTER,
  BaseItemType.DISRUPTER_PISTOL,
  BaseItemType.SONIC_PISTOL,
  BaseItemType.ION_RIFLE,
  BaseItemType.BOWCASTER,
  BaseItemType.BLASTER_CARBINE,
  BaseItemType.DISRUPTER_RIFLE,
  BaseItemType.SONIC_RIFLE,
  BaseItemType.REPEATING_BLASTER,
  BaseItemType.HEAVY_REPEATING_BLASTER,
];
const LIGHTSABER_ITEMS = [
  BaseItemType.LIGHTSABER,
  BaseItemType.DOUBLE_BLADED_LIGHTSABER,
  BaseItemType.SHORT_LIGHTSABER,
];
const ARMOR_ITEMS = [
  BaseItemType.JEDI_ROBE,
  BaseItemType.JEDI_KNIGHT_ROBE,
  BaseItemType.JEDI_MASTER_ROBE,
  BaseItemType.ARMOR_CLASS_4,
  BaseItemType.ARMOR_CLASS_5,
  BaseItemType.ARMOR_CLASS_6,
  BaseItemType.ARMOR_CLASS_7,
  BaseItemType.ARMOR_CLASS_8,
  BaseItemType.ARMOR_CLASS_9,
];
