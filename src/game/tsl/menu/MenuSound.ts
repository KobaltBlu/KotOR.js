...
export class MenuSound extends K1_MenuSound {
  ...
  async menuControlInitializer(skipInit: boolean = false) {
    ...
    this.LBL_MUSIC.addEventListener( 'hover', () => {
      this.LB_DESC.setSingleItemDescription(this.LBL_MUSIC.getHintText());
    });
    ...
    this.LBL_VO.addEventListener( 'hover', () => {
      this.LB_DESC.setSingleItemDescription(this.LBL_VO.getHintText());
    });
    ...
    this.LBL_FX.addEventListener( 'hover', () => {
      this.LB_DESC.setSingleItemDescription(this.LBL_FX.getHintText());
    });
    ...
    this.LBL_MOVIE.addEventListener( 'hover', () => {
      this.LB_DESC.setSingleItemDescription(this.LBL_MOVIE.getHintText());
    });
