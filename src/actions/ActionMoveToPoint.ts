...
export class ActionMoveToPoint extends Action {
  ...
  update(delta: number = 0): ActionStatus {
    ...
    this.target_position.set(this.getParameter<number>(0), this.getParameter<number>(1), this.getParameter<number>(2));
    ...
    if (!this.computedPath) {
      this.target_position.copy(
        this.owner.area.getNearestWalkablePoint(this.target_position, this.owner.getHitDistance())
      );
      this.calculatePath();
    }
