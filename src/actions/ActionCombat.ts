  ...
  update(delta: number = 0): ActionStatus {
    ...
    switch (combatAction.actionType) {
      ...
      case CombatActionType.ATTACK_USE_FEAT:
        ...
        attackAction.setParameter(
          7,
          ActionParameterType.INT,
          combatAction.resultsCalculated ? combatAction.attackAnimation : 0
        );
        attackAction.setParameter(
          8,
          ActionParameterType.INT,
          combatAction.resultsCalculated ? combatAction.attackResult : 4
        );
        attackAction.setParameter(
          9,
          ActionParameterType.INT,
          combatAction.resultsCalculated ? combatAction.attackDamage : 0
        );
      ...
      case CombatActionType.CAST_SPELL:
        ...
        spellAction.setParameter(
          5,
          ActionParameterType.DWORD,
          combatAction.target?.id || ModuleObjectConstant.OBJECT_INVALID
        ); //Target Object
        ...
        spellAction.setParameter(
          11,
          ActionParameterType.INT,
          combatAction.overrideSpell ? combatAction.overrideSpell.id : -1
        );
      ...
      case CombatActionType.ITEM_CAST_SPELL:
        {
          ...
          itemCastSpellAction.setParameter(
            9,
            ActionParameterType.INT,
            combatAction.overrideSpell ? combatAction.overrideSpell.id : -1
          );
          itemCastSpellAction.setParameter(
            10,
            ActionParameterType.DWORD,
            combatAction.item?.id ?? ModuleObjectConstant.OBJECT_INVALID
          );
