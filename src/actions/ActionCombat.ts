      ...
      if(combatAction){
        ...
        switch(combatAction.actionType){
          ...
          case CombatActionType.ATTACK_USE_FEAT:
            const attackAction = new GameState.ActionFactory.ActionPhysicalAttacks(ActionQueue.AUTO_INCREMENT_GROUP_ID);
          ...
          case CombatActionType.CAST_SPELL:
            const spellAction = new GameState.ActionFactory.ActionCastSpell(ActionQueue.AUTO_INCREMENT_GROUP_ID);
          ...
          case CombatActionType.ITEM_EQUIP:
            const equipAction = new GameState.ActionFactory.ActionEquipItem(ActionQueue.AUTO_INCREMENT_GROUP_ID);
          ...
          case CombatActionType.ITEM_UNEQUIP:
            const unequipAction = new GameState.ActionFactory.ActionUnequipItem(ActionQueue.AUTO_INCREMENT_GROUP_ID);
