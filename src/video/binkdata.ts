...
export const bink_tree_bits: number[][] = [
...
export const bink_tree_lens: number[][] = [
...
export const bink_patterns: number[][] = [
...
// Quant tables: 16 sets of 64 entries each (int32), we store as number[][]
// Values copied from FFmpeg; kept as numbers (JS 53-bit safe)
export const bink_intra_quant: number[][] = [
    [
...
export const bink_inter_quant: number[][] = [
    [
...
export const binkb_runbits: number[] = [
