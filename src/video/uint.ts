...
export function readU8(view: DataView, off: number): number {
  return view.getUint8(off);
}
export function readU16LE(view: DataView, off: number): number {
  return view.getUint16(off, true);
}
export function readU32LE(view: DataView, off: number): number {
  return view.getUint32(off, true);
}
export function readI32LE(view: DataView, off: number): number {
