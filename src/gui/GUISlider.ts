...
export class GUISlider extends GUIControl {
  ...
  onINIPropertyAttached() {
    if (this.iniProperty) this.setValue(GameState.iniConfig.getProperty(this.iniProperty) * 0.01);
  }
  ...
  mouseInside() {
    ...
    if (valueChanged && typeof this.onValueChanged === 'function') this.onValueChanged(this.value);
  }
