...
export class GUICheckBox extends GUIControl {
  ...
  constructor(menu: GameMenu, control: GFFStruct, parent: GUIControl, scale: boolean = false) {
    ...
    const odysseyGuiUniforms: Record<string, THREE.IUniform> = THREE.UniformsUtils.merge([
      odysseyGuiShader.getUniforms(),
    ]);
    ...
    this.borderSelected.mesh = new THREE.Mesh(this.borderSelected.geometry, [
      this.borderSelected.edge_material,
      this.borderSelected.corner_material,
    ]);
    ...
    this.borderSelected.fill.mesh = new THREE.Mesh(
      this.borderSelected.fill.geometry,
      this.borderSelected.fill.material
    );
    ...
    this.highlightSelected.mesh = new THREE.Mesh(this.highlightSelected.geometry, [
      this.highlightSelected.edge_material,
      this.highlightSelected.corner_material,
    ]);
    ...
    this.highlightSelected.fill.mesh = new THREE.Mesh(
      this.highlightSelected.fill.geometry,
      this.highlightSelected.fill.material
    );
    ...
    if (this.control instanceof GFFStruct) {
      ...
      if (this.hasSelected) {
        ...
        this.borderSelected.inneroffset = this.borderSelected.inneroffsety =
          selected.getFieldByLabel('INNEROFFSET').getValue() || 0;
      ...
      if (this.hashighlightSelected) {
        ...
        this.highlightSelected.inneroffset = this.highlightSelected.inneroffsety =
          highlightSelected.getFieldByLabel('INNEROFFSET').getValue() || 0;
    ...
    if (this.borderSelected.fill.texture != '') {
      ...
      TextureLoader.enQueue(
        this.borderSelected.fill.texture,
        this.borderSelected.fill.material,
        TextureType.TEXTURE,
        (texture: OdysseyTexture) => {
          if (texture == null) {
    ...
    if (this.highlightSelected.fill.texture != '') {
      ...
      TextureLoader.enQueue(
        this.highlightSelected.fill.texture,
        this.highlightSelected.fill.material,
        TextureType.TEXTURE,
        (texture: OdysseyTexture) => {
          if (texture == null) {
  ...
  onINIPropertyAttached() {
    if (this.iniProperty) this.setValue(GameState.iniConfig.getProperty(this.iniProperty));
  }
  ...
  setValue(value: boolean) {
    ...
    if (typeof this.onValueChanged === 'function') this.onValueChanged(this.value);
