class BIKObject {
  ...
  async play(file = '', onComplete = undefined) {
    ...
    Game.audioEngine.voGain.disconnect(this.audioCtx.destination);
    Game.audioEngine.musicGain.disconnect(this.audioCtx.destination);
    Game.audioEngine.sfxGain.disconnect(this.audioCtx.destination);
    this.frames = [];
  ...
  stop(){
    ...
    Game.audioEngine.voGain.connect(this.audioCtx.destination);
    Game.audioEngine.musicGain.connect(this.audioCtx.destination);
    Game.audioEngine.sfxGain.connect(this.audioCtx.destination);
  ...
  toFloat32Array(channel = undefined){
