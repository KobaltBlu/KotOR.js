...
THREE.TransformControls = function ( camera, domElement ) {
	...
	this.updateMatrixWorld = function () {
		...
		if ( this.object !== undefined ) {
			...
			this.object.matrixWorld.decompose( parentPosition, parentQuaternion, worldScale );
			this.object.parent.matrixWorld.decompose( worldPosition, worldQuaternion, parentScale );
		...
		if ( this.camera instanceof THREE.PerspectiveCamera ) {
			...
			eye.copy( parentPosition ).sub( worldPosition ).normalize();
