...
module.exports = {
  OP_CPDOWNSP: OP_CPDOWNSP,
  OP_RSADD: OP_RSADD,
  OP_CPTOPSP: OP_CPTOPSP,
  OP_CONST: OP_CONST,
  OP_ACTION: OP_ACTION,
  OP_LOGANDII: OP_LOGANDII,
  OP_LOGORII: OP_LOGORII,
  OP_INCORII: OP_INCORII,
  OP_EXCORII: OP_EXCORII,
  OP_BOOLANDII: OP_BOOLANDII,
  OP_EQUAL: OP_EQUAL,
  OP_NEQUAL: OP_NEQUAL,
  OP_GEQ: OP_GEQ,
  OP_GT: OP_GT,
  OP_LT: OP_LT,
  OP_LEQ: OP_LEQ,
  OP_SHLEFTII: OP_SHLEFTII,
  OP_SHRIGHTII: OP_SHRIGHTII,
  OP_USHRIGHTII: OP_USHRIGHTII,
  OP_ADD: OP_ADD,
  OP_SUB: OP_SUB,
  OP_MUL: OP_MUL,
  OP_DIV: OP_DIV,
  ...
  OP_COMPI: OP_COMPI,
  OP_MOVSP: OP_MOVSP,
  OP_STORE_STATEALL: OP_STORE_STATEALL,
  OP_JMP: OP_JMP,
  OP_JSR: OP_JSR,
  OP_JZ: OP_JZ,
  OP_RETN: OP_RETN,
  OP_DESTRUCT: OP_DESTRUCT,
  OP_NOTI: OP_NOTI,
  OP_DECISP: OP_DECISP,
  OP_INCISP: OP_INCISP,
  OP_JNZ: OP_JNZ,
  OP_CPDOWNBP: OP_CPDOWNBP,
  OP_CPTOPBP: OP_CPTOPBP,
  OP_DECIBP: OP_DECIBP,
  OP_INCIBP: OP_INCIBP,
  OP_SAVEBP: OP_SAVEBP,
  OP_RESTOREBP: OP_RESTOREBP,
  OP_STORE_STATE: OP_STORE_STATE,
  OP_NOP: OP_NOP,
  OP_T: OP_T,
};