...
NWScriptDefK1.Actions = {
  ...
  15:{
    ...
    args: [],
    action: function(args, _instr, action){
      return Game.module.area.Unescapable ? 1 : 0;
    }
  },
  16:{
  ...
  128:{
    ...
    action: function(args, _instr, action){
      ...
      return Game.GetObjectsInShape(args[0], args[1], args[2], args[3], args[4], args[5], this.objectsInShapeIdx);
    }
  },
  129:{
  ...
  152:{
    ...
    args: ["int", "int", "int"],
    action: function(args, _instr, action){
      Game.module.setReturnStrRef(args[0], args[1], args[2]);
    }
  },
  153:{
  ...
  197:{
    ...
    action: function(args, _instr, action){
      ...
      return Game.GetObjectByTag(args[0], 0, OBJECT_TYPE_WAYPOINT);
    }
  },
  198:{
  ...
  200:{
    ...
    args: ["string", "int"],
    action: function(args, _instr, action){
      return Game.GetObjectByTag(args[0], args[1]);
    }
  },
  201:{
  ...
  227:{
    ...
    args: ["int", "object", "int"],
    action: function(args, _instr, action){
      return Game.GetNearestObject(args[0], args[1], args[2]-1);
    }
  },
  228:{
  ...
  229:{
    ...
    action: function(args, _instr, action){
      ...
      return Game.GetNearestObjectByTag(args[0], args[1], args[2]-1);
    }
  },
  230:{
  ...
  239:{
    ...
    args: ["int"],
    action: function(args, _instr, action){
      return Global.kotorTLK.GetStringById(
        args[0]
        );
    }
  },
  ...
  284:{
    ...
    args: ["int", "string"],
    action: function(args, _instr, action){
      Game.module.setCustomToken(args[0], args[1]);
    }
  },
  285:{
  ...
  337:{
    ...
    type: 3,
    args: ["object", "int"],
    action: function(args, _instr, action){ //GetIsDoorActionPossible
  ...
  338:{
    ...
    type: 0,
    args: ["object", "int"],
    action: function(args, _instr, action){ //DoDoorAction
  ...
  370:{
    ...
    args: ["int"],
    action: function(args, _instr, action){
      Game.camera_shake.playRumblePattern(args[0]);
    }
  },
  371:{
    ...
    args: ["int"],
    action: function(args, _instr, action){
      Game.camera_shake.stopRumblePattern(args[0]);
    }
  },
  372:{
  ...
  378:{
    ...
    action: function(args, _instr, action){
      if(args[0] instanceof ModuleStore){
        Game.MenuStore.Open(args[0], args[1], args[2], args[3]);
      }
    }
  },
  379:{
  ...
  561:{
    ...
    args: [],
    action: function(args, _instr, action){
      return Game.module.Mod_Name.GetValue();
    }
  },
  562:{
  ...
  647:{
    ...
    args: ["vector"],
    action: function(args, _instr, action){
      Game.module.area.MiniGame.Player.position.copy(args[0]);
    }
  },
  648:{
  ...
  739:{
    ...
    args: ["int"],
    action: function(args, _instr, action){
      Game.MenuGalaxyMap.Open(args[0]);
    }
  },
  740:{
