class TalentSpell extends TalentObject {
  ...
  save(){
    let spellStruct = new Struct(3);
    spellStruct.AddField( new Field(GFFDataTypes.WORD, 'Spell') ).SetValue(this.getId());
    //spellStruct.AddField( new Field(GFFDataTypes.SHORT, 'SpellFlags') ).SetValue(this.getFlags());
    //spellStruct.AddField( new Field(GFFDataTypes.SHORT, 'SpellMetaMagic') ).SetValue(this.getMetaMagic());
    return spellStruct;
  }
