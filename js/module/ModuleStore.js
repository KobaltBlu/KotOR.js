...
class ModuleStore extends ModuleObject {
  ...
  save(){
    ...
    gff.RootNode.AddField( new Field(GFFDataTypes.INT, 'MarkDown') ).SetValue(this.markDown);
    gff.RootNode.AddField( new Field(GFFDataTypes.INT, 'MarkUp') ).SetValue(this.markUp);
    gff.RootNode.AddField( new Field(GFFDataTypes.RESREF, 'OnOpenStore') ).SetValue (this.onOpenStore instanceof NWScriptInstance ? this.onOpenStore.name : '' );
    gff.RootNode.AddField( new Field(GFFDataTypes.BYTE, 'BuySellFlag') ).SetValue(this.buySellFlag);
    ...
    gff.RootNode.AddField( new Field(GFFDataTypes.FLOAT, 'XOrientation') ).SetValue(this.rotation.x);
    gff.RootNode.AddField( new Field(GFFDataTypes.FLOAT, 'YOrientation') ).SetValue(this.rotation.y);
    gff.RootNode.AddField( new Field(GFFDataTypes.FLOAT, 'ZOrientation') ).SetValue(this.rotation.z);
