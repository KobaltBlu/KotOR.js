...
class ModuleMGGunBullet extends ModuleObject {
  ...
  update(delta = 0){
    ...
    if(this.life >= this.lifespan){
      ...
      if(this.owner.isPlayer){
        const enemies = Game.module.area.MiniGame.Enemies;
        ...
        const player = Game.module.area.MiniGame.Player;
...
module.exports = ModuleMGGunBullet;