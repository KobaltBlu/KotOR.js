class GameMenu {
  ...
  LoadMenu(args={}){
    ...
    this.LoadBackground( () => {
      ...
      ResourceLoader.loadResource(ResourceTypes['gui'], args.name, (guiBuffer) => {
        ...
        this.tGuiPanel.createControl( (panelControl) => {
  ...
  SetWidgetHoverActive(widget = undefined){
    ...
    if(this.activeWidget instanceof GUIControl){
      this.activeWidget.onHoverOut();
    }

    this.activeWidget = widget;

    if(this.activeWidget instanceof GUIControl){
      this.activeWidget.onHoverIn();
    }
